...
contract BitPay {
    ...
    struct sendReceive {
        ...
        uint256 amount;
        string message;
        address otherPartiesAddress;
        string otherPartiesName;
    }
    ...
    function addHistory(
        ...
        newSend.otherPartiesAddress = receiver;
        if (names[receiver].hasName) {
            newSend.otherPartiesName = names[receiver].name;
        }
        ...
        newReceive.otherPartiesAddress = sender;
        if (names[sender].hasName) {
            newReceive.otherPartiesName = names[sender].name;
        }
